...
- get_delegate_status: list or poll detached workflows, child threads, and sidekicks; use get_task_output only for background bash tasks
...
- manage_skill_repos: add/remove/update/list git remotes that supply skill packs (only when the user asks to install or manage skills)`
  ...
  const multiAgentGuideline =
    "- Delegation: hand separable work to your delegates early and often; keep quick answers, trivial edits, and serial debugging yourself." +
    sidekickGuideline +
